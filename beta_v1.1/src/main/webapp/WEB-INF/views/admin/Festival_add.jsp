...
<div class="table-container">
	<table>
	<tr>
		<td style="text-align:center;"><h2>2023 문화유산 미디어아트 수원화성</h2>
			<button class="btn btn-primary" type="submit" id="Fmodify">축제등록</button>
		</td>
		...
		<tr>
			...
			<table>
				<tr>
					<td rowspan=7><input type="button" value="사진넣기"></td>
				</tr>
				<tr>
					<td>장소</td>
			...
			<td>
				<table>
					...
					<tr>
						...
						<div id="infoContent">
						<h1>공연시간 정보</h1>
						<p><input type="text" style="width:700px;height:200px;font-size:16px;"></p>
