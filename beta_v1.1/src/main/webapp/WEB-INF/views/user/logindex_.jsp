...
<jsp:include page="/resources/user/include/loginheader.jsp" />
		...
		<c:if test="${fn:containsIgnoreCase(item.title, param.keyword) || fn:containsIgnoreCase(item.spatialCoverage, param.keyword)}">
			<tr>
