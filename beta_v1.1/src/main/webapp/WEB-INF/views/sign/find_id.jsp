...
<html>
	...
	function getEmail() {
    	...
    	$.ajax({
    		type : "get",
    		url	 : "${pageContext.request.contextPath}/mail/mail_auth?mail=" + email,
    		dataType: "HTML",
	...
	<body>
		...
		<form id="emailForm" action="${pageContext.request.contextPath}/find_id" method="post" onsubmit="return checkform();">
		<table style="width: 350px; margin: 0 auto;">
			...
			<tr>
				<td>이메일<div style="display: flex; align-items: center;">
			        <input type="text" name="EMAIL" id="to" style="width: 300px; height: 50px;" value="kimcm5221@naver.com">
			...
			<tr>
				<td><div style="display: flex; align-items: center;">
			        <input type="text" name="code" id="emailsign" style="width: 300px; height: 50px;">
